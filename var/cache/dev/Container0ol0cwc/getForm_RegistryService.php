...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ParentsForm' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ParentsForm']) ? $this->services['AppBundle\Form\ParentsForm'] : $this->services['AppBundle\Form\ParentsForm'] = new \AppBundle\Form\ParentsForm()) && false ?: '_'};
