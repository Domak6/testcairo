 ...
 */
class Parents extends \AppBundle\Entity\Parents implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Parents' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Parents' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Parents' . "\0" . 'surname', '' . "\0" . 'AppBundle\\Entity\\Parents' . "\0" . 'childrens'];
        }
    ...
    public function addChildrens(\AppBundle\Entity\Children $children)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addChildrens', [$children]);

        return parent::addChildrens($children);
    }
